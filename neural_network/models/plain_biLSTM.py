...
class RNN(chainer.Chain):
    ...
    def __init__(self, n_lstm_layers, n_mid_units, n_out, win_size, batch_size, att_units_size, dropout=0.5):
        ...
        with self.init_scope():
            ...
            self.encoder1 = L.NStepBiLSTM(1, n_mid_units, n_mid_units, dropout)
            self.encoder2 = L.NStepBiLSTM(1, n_mid_units*2, n_mid_units, dropout)
            self.encoder3 = L.NStepBiLSTM(1, n_mid_units*2, n_mid_units, dropout)

            self.encoder4 = L.NStepBiLSTM(1, n_mid_units*2, n_mid_units, dropout)
            self.encoder5 = L.NStepBiLSTM(1, n_mid_units*2, n_mid_units, dropout)

            self.output = L.Linear(n_mid_units*2, n_word_out, initialW=initializer)
